...
At UNICEF's prestigious meet in Mumbai, the anthem was officially recognised and proclaimed as the Student Anthem for students worldwide a proud moment for QMIS and a sestament so our vision of inspiring global futures.
  ...
  Dhawan Space Centre in Sriharikota. This was a first-of-its-kind visit, and the experience — 
  from interacting with scientists to touring launch facilities — sparked dreams of space 
  and science.
</p>
...
<br/><br/>Through this initiative, QMIS is helping close that aspiration gap — by giving students not just a visit, but the chance to dream bigger
              </p>
            </div>
 ...
 <div className="text-gray-700 mt-8 text-center leading-relaxed">
      ...
      <section className="w-full py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="max-w-4xl mx-auto text-lg  text-justify leading-relaxed text-center mb-12">
           QMIS partners with the Chellamuthu Trust, led by Dr. C. Ramasubramanian, to introduce KARKO — a unique program where selected QMIS students collaborate with government school students to break learning barriers through shared experiences.
          </p>
          ...
          <ul className="max-w-5xl mx-auto list-disc pl-6 space-y-4 text-lg">
            <li>School–community partnerships (involving mental health experts, organizations, NGOs) are shown to increase student engagement by up to 40%, and boost academic performance by 30%.</li>
            <li>Such partnerships provide critical emotional support to students, creating a support network that transcends classroom walls.</li>
          </ul>
      ...
      <section className="w-full py-16 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8 mb-12">
          <Image src="/social-outreach/3.png" width={506} height={359.67} className="rounded-lg shadow w-full object-cover" alt="" />
          <Image src="/social-outreach/4.png" width={506} height={359.67} className="rounded-lg shadow w-full object-cover" alt="" />
        </div>
      ...
      {/* ================= IGCA ================= */}
    <section className="w-full bg-[#0c1b39] text-white py-16">
