...
export default function AcademicOverview() {
  const academicImages = [
    "/academic-overview/5.webp",
    "/academic-overview/6.webp",
    "/academic-overview/7.webp",
  ];

  const academicImagesAlt = Array.from(
    { length: 3 },
    ...
    <>
      ...
      <div className="bg-grid-dots">
        <section className="max-w-7xl mx-auto px-6 md:px-12 py-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-gray-500 leading-loose text-lg">
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 py-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-gray-500 leading-loose text-lg order-2 md:order-1">
            <p className="mb-5">
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10">
          <section className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="order-1 w-full h-[400px] md:h-[500px] rounded-lg overflow-hidden shadow-xl relative">
              <HoverExpandGallery images={academicImages} />
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10">
          <section className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="order-2 w-full h-[400px] md:h-[500px] rounded-lg overflow-hidden shadow-xl relative">
              <HoverExpandGallery images={academicImagesAlt} />
            </div>
          </section>
        </div>
      </div>
