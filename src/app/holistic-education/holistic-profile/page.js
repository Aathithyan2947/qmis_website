  ...
  return (
    <>
      ...
      <div className="bg-gray-50 py-12 px-4 bg-grid-dots md:px-12 lg:px-24 text-gray-800">
        ...
        <p className="max-w-3xl mx-auto text-center text-gray-600 mb-12 leading-loose">
          ...
          {sections.map(({ title, icon: Icon, items }, idx) => (
            ...
            >
              ...
              <div>
                ...
                <ul className="space-y-2 list-disc pl-5 text-gray-700 leading-loose">
                  {items.map((item, i) => (
                    <li key={i}>{item}</li>
                  ))}
                </ul>
        ...
        <p className="max-w-4xl mx-auto text-gray-600 mt-12 leading-loose text-center">
        ...
        <p className="max-w-4xl mx-auto text-gray-600 mt-6 leading-loose text-center">
