...
export default function ClubsAndActivities() {
  return (
    <>
        ...
        <section className="w-full bg-white py-16">
          <div className="px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 mt-10">
              <p className="text-gray-500 leading-loose text-sm md:text-base order-2 md:order-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12 mt-14">
              ...
              {/* Right Paragraphs */}
              <div className="text-gray-500 leading-loose text-sm md:text-base">
                <p>
      ...
      {/* 3rd Section - Full width dark blue section */}
      <div className="w-full bg-darkBlue-100 py-16">
        <div className="max-w-5xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            {/* Text */}
            <p className="order-2 md:order-1 text-white leading-loose text-sm md:text-base max-w-lg">
      ...
      {/* Rest of content inside max-w-5xl container */}
      <div className="max-w-5xl mx-auto">
        ...
        <div className="px-6">
          ...
          {/* Two column section */}
          <div className="grid grid-cols-1 md:grid-cols-2 py-5 items-center gap-10">
            {/* Left paragraph */}
            <p className="text-gray-500 order-2 md:order-1 leading-loose text-sm md:text-base max-w-xl">
        ...
        <section className="mt-16 px-6">
          ...
          <div className="mb-16">
            ...
            <p className="text-gray-500 leading-loose mb-6 max-w-4xl">
